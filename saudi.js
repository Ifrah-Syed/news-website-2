...
//open the object //first arg is what kind of request, second is the source of data, third is true for asynchronous 
xhr.open('GET', `https://newsapi.org/v2/top-headlines?country=sa&apiKey=${apikey}`, true)
xhr.getResponseHeader('Content-type', 'application/json')

//this function is run when xhr object is loaded
xhr.onload = function () {
    if (this.status === 200) {
